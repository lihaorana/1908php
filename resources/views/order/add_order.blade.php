    ...
    <div class="maincont">
     ...
     <div class="dingdanlist" >
      <table>
       ...
       <tr>
        <td class="" width="75%" colspan="2"><a href="{{url('/add_address/')}}">新增收货地址</a></td>
        <td align=""><a href="{{url('/add_address/')}}">
                <img src="/static/index/images/jian-new.png" />
        </a>
        </td>
       </tr>
       ...
       <tr>
        <td class="dingimg" width="15%">
            <img src="/static/index/images/zf3.jpg" />
        </td>
        <td width="50%">
